...
echo "Extracting ene and pdb files"
...
echo "$nLIGANDS ligand structures for $nRECEPTORS receptor structures"


echo "building complexes_all.sorted.ene" # vmdframe#,ene,vina#,receptormodel#,splittedligand#
r=1
...
echo "building complexes_all.sorted.pdb"
